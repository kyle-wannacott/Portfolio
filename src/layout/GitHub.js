...
export class Github extends Component {
	...
	componentDidMount() {
		...
		// script.src =
		// "https://kyle-wannacott.github.io/table-sort-js/table-sort.js";
		// script.async = true;
		...
		axios
			.get(`https://api.github.com/users/kyle-wannacott/repos`, config)
			.then((res) => {
				const repos = res.data;
				this.setState({ repos });
			});
		axios
			.get(`https://api.github.com/users/kyle-wannacott`, config)
			.then((res) => {
				const user = res.data;
				this.setState({ user });
			});
		axios
			.get(`https://api.github.com/users/kyle-wannacott/starred`, config)
			.then((res) => {
			...
			<div className="container">
				...
				<div className="bioInfo">
					...
					<div className="GitHubChart">
						<img
							src="http://ghchart.rshah.org/kyle-wannacott"
